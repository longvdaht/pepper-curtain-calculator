...
export default [
  ...
  },
  {
    ...
    helperText:
      "Measure the width of your window at 3 points inside window casing—top, middle, bottom; use the narrowest measurement and round up to the nearest 1/8”. Add +2”",
  ...
  },
  {
    ...
    helperText:
      "Measure the height of the window at 3 points, including the molding—left, center, right; use the longest measurement to the nearest 1/4”. Add 2-4” for the top clearing.",
